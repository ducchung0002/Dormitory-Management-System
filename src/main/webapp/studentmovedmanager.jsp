    ...
    <div class="row">
        <div class="col-sm-10">
            ...
            <div class="table-responsive">
                            ...
                            <td>
                                <div class="btn-group">
                                    <button type="button" class="btn btn-default "
                                        ...
                                        <i class="fa fa-user-o">Chuyển vào lại</i>
                                    </button>
                ...
                <form method="post" action="${pageContext.request.contextPath}/student?method=movein" class="form-horizontal" style="margin-top: 0px" role="form"
                      id="form_data" style="margin: 20px;">
...
<script>
    $('#updateUserModal').on('show.bs.modal', function (event) {
        ...
        modal.find('.modal-title').text('Chuyển vào lại')
