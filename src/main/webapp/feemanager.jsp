...
<div class="container-fluid">
    <form method="post" action="fee?method=save" class="form-horizontal" style="margin-top: 0px" role="form"
          id="form_data" style="margin: 20px;">
        <div role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="myModalLabel">Thêm thông tin nộp phí</h4>
                    </div>
                    <div class="modal-body">
                        <form class="form-horizontal" role="form">
                            ...
                            <div class="form-group">
                                <label for="user_id" class="col-sm-3 control-label">Năm</label>
                                <div class="col-sm-9">
                                    <input type="number" required class="form-control" name="year" placeholder="">
                                </div>
                            </div>

                            <div class="form-group">
                                <label for="user_id" class="col-sm-3 control-label">Tháng</label>
                                 <div class="col-sm-9">
                                    <input type="number" required class="form-control" name="month" placeholder="">
                                      </div>
                            </div>

                            <div class="form-group">
                                                            <label for="user_id" class="col-sm-3 control-label">Tiền</label>
  <div class="col-sm-9">
