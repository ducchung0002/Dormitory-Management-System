    ...
    <form class="form-horizontal col-md-offset-3" id="login_form" action="account?method=login" method="post">
      ...
      <div class="col-md-9">
        ...
        <div class="form-group">
          ...
          <label class="radio-inline">
            <input type="radio" name="type" value="dormitoryAdmin" class="radio-inline" > Quản lý KTX
          </label>
        </div>
        <div class="form-group col-md-offset-9">
          <button type="submit" class="btn btn-success pull-left" name="submit">Đăng nhập</button>
          <button type="reset" class="btn btn-secondary pull-right" name="submit">Hủy</button>
        </div>
      </div>
    </form>
  </div>
