        ...
        <div class="col-sm-10">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form role="form" class="form-inline" action="${pageContext.request.contextPath}/fee?method=search" method="post">
                        <div class="form-group">
                            <label for="name">Year: </label>
                             <input type="number" class="form-control" name="year" maxlength="12" style="width: 130px">
                        </div>
                        <div class="form-group" style="margin-left: 20px">
                            <label>Month: </label>
                            <input type="number" class="form-control" name="month" maxlength="12" style="width: 130px">
                        </div>
                        <div class="form-group " style="margin-left: 20px">
